...
try:
    element = driver.find_element(By.XPATH, "//header")
except NoSuchElementException:
    print("No element found")

element = driver.find_element(By.XPATH, "//header")  # this element is visible
...
assert not_found
assert "Contacs" not in driver.current_window_handle
